...
import {
  academyCoachProfileSchema,
  type AcademyCoachProfileSchema,
} from "../schemas/academy-coach-profile.schema"

import { useCompleteAcademyCoachProfile }
from "../hooks/useCompleteAcademyCoachProfile"

export function AcademyCoachProfileForm() {
  const mutation =
    useCompleteAcademyCoachProfile()
  ...
  const {
    ...
    useForm<AcademyCoachProfileSchema>({
  ...
  const selectedDisciplines =
    watch("discipline_ids")

  const dpdpConsent =
    watch("dpdp_consent")

  function onSubmit(
    values: AcademyCoachProfileSchema
  ) {
      ...
      <div className="space-y-5 rounded-3xl border border-border bg-card/40 p-5 backdrop-blur-xl">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Input
              placeholder="https://cdn.example.com/certificates/academy-coach.pdf"
              className="h-12 border-border bg-background/50 text-foreground placeholder:text-muted-foreground focus-visible:ring-1"
              {...register(
                "coaching_certificate_proof"
              )}
